...
function TaskView() {
    ...
    const fetchTasks = async (username) => {
        if (username) {
            ...
            console.log("username : ", username)
            const response = await axios.get(`${process.env.REACT_APP_TASK_SERVICE_URL}/tasks/viewTasks`, {
    ...
    const fetchFilteredTasks = (status,username) => {
        axios.get(`${process.env.REACT_APP_TASK_SERVICE_URL}/tasks/viewTasks`, {
            params: {
                username: username,
                status: status
            }
    ...
    const handleTaskUpdate = (e) => {
       e.preventDefault();
        if(taskToEdit) {
           ...
           axios.post(`${process.env.REACT_APP_TASK_SERVICE_URL}/tasks/updateTask`, {
               username: username,
